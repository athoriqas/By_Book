      ...
      <div class="container px-4 px-lg-5 my-5">
        <div class="text-center">
          ...
          <p class="lead fw-normal text-muted mb-0">
            Learn more about our bookstore and what we offer.
          </p>
        </div>
        <div class="row gx-4 gx-lg-5 justify-content-center">
          <div class="col-lg-8">
            <p class="text-muted">
              Our bookstore offers a wide range of books from various genres,
              ensuring that there's something for every reader. Whether you're
              looking for the latest bestsellers, classic literature, or
              non-fiction, we've got you covered.
            </p>
            <p class="text-muted">
              We pride ourselves on providing excellent customer service and a
              welcoming atmosphere for all book lovers. Our knowledgeable staff
              is always on hand to help you find your next great read.
            </p>
          </div>
        </div>
      </div>
